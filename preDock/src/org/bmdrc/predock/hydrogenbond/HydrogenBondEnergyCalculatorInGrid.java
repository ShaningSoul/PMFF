 ...
 */
public class HydrogenBondEnergyCalculatorInGrid extends AbstractInterEnergyFunction implements Serializable {
    ...
    public HydrogenBondEnergyCalculatorInGrid(BindingSite theBindingSite, ISbffInterCalculationParameter theCalculationParameter,
            MoveTogetherAtomNumberList theMoveTogetherAtomNumberMap) {
        super(theBindingSite.getAminoAcids(), theCalculationParameter, theMoveTogetherAtomNumberMap);
    }

    public CalculableHydrogenBondListInGrid getCalculableHydrogenBondList() {
    ...
    private double __calculateEnergyFunction(CalculableHydrogenBondSetInGrid theCalculableHydrogenBondSet) {
        ...
        if (theHADistance < this.itsCalculationParameter.getMaxNonbondingCutoff()) {
            ...
            if (theCalculableHydrogenBondSet.getType().equals(CalculableHydrogenBondSetInGrid.ACCEPTOR_TYPE_IN_LIGAND)) {
            ...
            } else if (theCalculableHydrogenBondSet.getType().equals(CalculableHydrogenBondSetInGrid.DONOR_TYPE_IN_LIGAND)) {
